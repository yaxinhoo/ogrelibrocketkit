...
const gkString gkDefaultBlend   = "momo_ogre_i_mini.blend";
//const gkString gkDefaultBlend   = "HudOverlayTest.blend";
//const gkString gkDefaultBlend   = "InGameHUDTest2.blend";
//const gkString gkDefaultBlend   = "multitouch_test.blend";
const gkString gkDefaultConfig  = "OgreKitStartup.cfg";

class OgreKit : public gkCoreApplication, public gkWindowSystem::Listener,public Rocket::Core::EventListener
{
public:
    gkString    m_blend;
    gkScene*	m_scene;
...
void OgreKit::ProcessEvent(Rocket::Core::Event& event)
{
